...
def crossover(cross):
    """Return an inspired crossover function based on the given function.
    ...
    def inspired_crossover(random, candidates, args):
        ...
        for i, (mom, dad) in enumerate(zip(moms, dads)):
            ...
            for o in offspring:
                children.append(o)
        return children
    inspired_crossover.single_crossover = cross
    return inspired_crossover
