...
def mutator(mutate):
    """Return an inspired mutator function based on the given function.
    ...
    def inspired_mutator(random, candidates, args):
        mutants = []
        for i, cs in enumerate(candidates):
            mutants.append(mutate(random, cs, args))
        return mutants
    inspired_mutator.single_mutation = mutate
    return inspired_mutator
